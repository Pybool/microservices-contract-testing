...
```
pact-demo/
├── orders-service/                  # Node.js / TypeScript
│   ├── src/
│   │   ├── types.ts                 # Domain types (Order, User, DTOs)
│   │   ├── logger.ts                # Winston logger
│   │   ├── app.ts                   # Express app factory
│   │   ├── server.ts                # Entry point
│   │   ├── controllers/
│   │   │   └── ordersController.ts  # HTTP layer + validation
│   │   ├── services/
│   │   │   ├── orderService.ts      # Business logic
│   │   │   └── usersClient.ts       # HTTP client → Users service
│   │   ├── repositories/
│   │   │   └── orderRepository.ts   # Data access (in-memory)
│   │   ├── middleware/
│   │   │   └── errorHandler.ts
│   │   └── __tests__/
│   │       ├── orderService.unit.test.ts    # Unit tests
│   │       └── usersClient.pact.test.ts     # Pact consumer tests ← contract defined here
│   └── pacts/                       # Generated pact JSON — commit this!
│
├── users-service/                   # Python / FastAPI
│   ├── app.py                       # FastAPI app
│   ├── test_provider_pact.py        # Pact provider verification ← reads pact JSON
│   └── requirements.txt
│
└── docs/
    └── JIRA_BUG_REPORTING.md
```
